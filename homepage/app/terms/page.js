      ...
      <main className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <section className="mb-12">
            ...
            <p className="mb-4">By using the TargetMailer, you agree to the following terms:</p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>Email generation is limited to 5 per day with a 60-second cooldown between generations(as of now)</li>
